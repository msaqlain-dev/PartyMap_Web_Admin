...
export default function EditMarker() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        navigate("/markers/view/" + id);
      } else {
        const error = await res.json();
        alert(error.message || "Failed to update marker");
      }
    } catch (err) {
      console.error(err);
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-2xl font-bold text-center mb-6">Edit Marker</h1>
